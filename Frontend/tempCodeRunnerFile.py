...
Aassistantname = env_vars.get("Assistantname")
...
class ChatSection(QWidget):
      ...
      def __init__(self):
            ...
            #layout.setSizePolicy(QVBoxLayout.SetDefaultConstraint)
            ...
            movie.start()
            #layout.addWiget(self.gif_label)
            layout.addWidget(self.gif_label)

            self.gif_label = QLabel("")
            #self.label.setStyleShet("color: white; font-size:16px; margin-right: 195px; border:none; margin-top: -30px;")
            self.label.setStyleSheet("color: white; font-size:16px; margin-right: 195px; border:none; margin-top: -30px;")

            self.label.setAligment(Qt.Alignright)
